...
\end{center}\\
\item In Figure \ref{fig:bookExtract2}, we see the rules for parsing all sorts of expressions. Once the expression has been parsed and stored in the aforementioned classes, evaluating them only requires us to call the corresponding python operators.
